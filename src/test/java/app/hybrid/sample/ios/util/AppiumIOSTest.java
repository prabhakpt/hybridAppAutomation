package app.hybrid.sample.ios.util;
...
import app.hybrid.sample.ios.page.IOSClickCounterPage;
import app.hybrid.sample.ios.page.IOSHomePage;
import app.hybrid.sample.ios.page.IOSWorkLocationPage;
...
public class AppiumIOSTest {
    ...
    public void setUp() throws Exception {
        ...
        File resourcesDirectory = new File("src/test/resources");
		 String appPath  = resourcesDirectory.getAbsolutePath()+("\\apps\\LocalSample.apk");
